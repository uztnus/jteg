 ...
 *
 */
public class TegProtocolOneGameServer {

	private Logger _log = Logger.getLogger("tegserver");

	public static void main(String[] args) throws IOException {
		PropertyConfigurator.configure("conf/log4j.properties");
		TegProtocolOneGameServer s = new TegProtocolOneGameServer();
	...
	public TegProtocolOneGameServer() {
	...
	/* parse the arguments */
	private static void configureUsingArguments(TegProtocolOneGameServer s,
			String[] argv) {
		int i;
